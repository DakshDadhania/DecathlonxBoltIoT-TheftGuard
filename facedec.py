...
API_KEY = '0f2b3031-2db0-424e-95f7-19f9ba1d6b73'
DEVICE_ID = 'BOLT12654402'
FRAME_SIZE = 10
MUL_FACTOR = 3
SID = 'ACfc7b434065f205503bab312e0b31f4f7'
AUTH_TOKEN = 'f58e58035e13f84e8c35362c61b27a9a'
FROM_NUMBER = '+14155238886'
TO_NUMBER = '+917600027850'
FROM_WHATSAPP = 'whatsapp:+14155238886'
TO_WHATSAPP = 'whatsapp:+917600027850'

MAILGUN_API_KEY = '99754857f35bbd58963b68396db6f9a8-7ca144d2-47da1bcf'
SANDBOX_URL = 'https://app.mailgun.com/app/sending/domains/sandbox06e01e78bf7049e9b7b4283a33b5eaa4.mailgun.org'
SENDER_EMAIL =  'test@sandbox06e01e78bf7049e9b7b4283a33b5eaa4.mailgun.org'
RECIPIENT_EMAIL = 'harshder93427@gmail.com'
...
# grab the indexes of the facial landmarks for the left and# import the necessary packages
from scipy.spatial import distance as dist
from imutils.video import FileVideoStream
from imutils.video import VideoStream
from imutils import face_utils
...
image = face_recognition.load_image_file("retouchcv.jpg")
mface_encoding = face_recognition.face_encodings(image)[0]
